...
export async function updatePassword(data: UpdatePassword, token: string) {
    return await fetchApiResponse(`user/password`, {
      method: 'PATCH',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
...
export async function deleteUserAccount(data: DeleteUserAccount, token: string) {
    return await fetchApiResponse(`user`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
...
export async function updateUserInfo(data: UpdateUserInfo, token: string) {
    return await fetchApiResponse(`user`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${token}`,
